        ...
        <div className='container text-center text-md-start mt-5'>
          <div className='row mt-3'>
            <div className='col-md-3 col-lg-4 col-xl-3 mx-auto mb-4'>
              <h6 style={{color:'#28a755'}} className='text-uppercase fw-bold mb-4'>
                <i className='fas fa-gem me-3'></i>RecrutMe
              </h6>
              <p>
                RecrutMe helps you find you dream job and build your profional career.
              </p>
            </div>
            ...
            <div className='col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4'>
              <h6 style={{color:'#28a755'}} className='text-uppercase fw-bold mb-4'>    Contact</h6>
              <p>
